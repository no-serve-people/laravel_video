                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="<?php echo e($dy['dy_id']); ?>" id="dyid" name="dy_id">
                                <input type="text" class="form-control" id="field-1" value="<?php echo e($dy['dy_title']); ?>" name="dy_title" placeholder="请输入视频名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-2" name="dy_desc" value="<?php echo e($dy['dy_desc']); ?>" placeholder="请输入视频描述" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" class="form-control" name="dy_img" id="field-3"  value="<?php echo e($dy['dy_img']); ?>" placeholder="请输入视频图片地址">
                        </div>
                     </div>
                     <div class="form-group-separator"></div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="dy_addr" cols="5" rows="5" id="field-4" placeholder="请输入视频播放地址"><?php echo e($dy['dy_addr']); ?></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-4">视频排序</label>
                            <div class="col-sm-10">
                                <input type="number" class="form-control" name="dy_sort" value="<?php echo e($dy['dy_sort']); ?>" id="field-5" placeholder="请输入视频排序,数字越到越靠前">
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
