...
<?php $__env->startSection('title','电影'); ?>
			...
			<div class="stui-pannel-box">
				<div class="stui-pannel_hd">
					<div class="stui-pannel__head active bottom-line clearfix">
						<h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_25.png"/>热门电影</h3>
						...
						<li><a href="/movielist/<?php echo e($v); ?>/1.html"><?php echo e($key); ?></a></li>
	   ...
	   <?php $__currentLoopData = $dys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <li class="col-md-6 col-sm-4 col-xs-3">
         <div class="stui-vodlist__box">
          <a class="stui-vodlist__thumb lazyload im-shadow" href="/play/<?php echo e($dy['url']); ?>.html" title="<?php echo e($dy['title']); ?>" data-src="<?php echo e($dy['img']); ?>">
		  <span class="play hidden-xs"></span><span class="pic-text text-right"><?php echo e($dy['pf']); ?></span></a>
          <div class="stui-vodlist__detail">
           <h4 class="title text-overflow"><a href="/play/<?php echo e($dy['url']); ?>.html" title="<?php echo e($dy['title']); ?>"><?php echo e($dy['title']); ?></a></h4>
		   <p class="text text-overflow text-muted hidden-xs"><?php echo e($dy['star']); ?></p>
          </div>
         </div>
		</li>
		 <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
