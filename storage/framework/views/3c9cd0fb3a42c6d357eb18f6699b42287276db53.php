        ...
        <div class="hy-layout clearfix">
         <div class="hy-layout clearfix">
            ...
            <div style="">
                ...
                <p class="hy-layout clearfix" style="color:#FFFFFF;text-align:center"><a href="#" data-toggle="modal" data-target="#myModal">免责声明</a><br>Copyright:<a href="#" target="_blank"><?php echo e(config('webset.webicp')); ?>-<?php echo e(config('webset.copyright')); ?></a></p>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <p style="padding: 0 4px;text-align:center;color:#000" class="container-fluid">
                ...
                若本站收录的节目无意侵犯了贵司版权，请给网页底部邮箱地址来信,我们会及时处理和回复<br>如果本站没有您想要的电影或电视剧，请注册后在会员中心，求片，注册会员是免费的哦！<br>请支持挚手网络 www.zhishouwl.cn</p>
      </div>
