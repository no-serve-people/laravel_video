                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-1" value="{{config('webset.webname')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-11" value="{{config('webset.websubname')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-9" name="webdomin"
                                       value="{{config('webset.webdomin')}}" placeholder="请输入网站关键字,用逗号隔开" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-2" name="webkeywords"
                                       value="{{config('webset.webkeywords')}}" placeholder="请输入网站关键字,用逗号隔开" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="webdesc"
                                       value="{{config('webset.webdesc')}}" placeholder="请输入网站描述信息" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="notice" id="field-20" value="{{config('webset.notice')}}" placeholder="请输入首页公告" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-7" name="webdir"
                                       value="{{empty(config('webset.webdir'))?'admin':config('webset.webdir')}}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="webicp" id="field-4"
                                       value="{{config('webset.webicp')}}" placeholder="请输入网站备案信息" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="webmail" id="field-12"
                                       value="{{config('webset.webmail')}}" placeholder="请输入站长邮箱" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" name="copyright" id="field-13"
                                       value="{{config('webset.copyright')}}" placeholder="请输入底部版权" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <img src="/public/static/{{config('webset.weblogo')}}" height="50px" width="100px">
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" id="field-14"  name="theme" style="display: inline-block;">
                                        <option value="white" {{config('webset.theme')=='white'?'selected':''}}>白色</option>
                                        <option value="black" {{config('webset.theme')=='black'?'selected':''}}>黑色</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="cy" cols="5" id="field-8"
                                          placeholder="输入畅言代码">{!! config('webset.cy') !!}</textarea>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" name="webtongji" cols="5" id="field-6"
                                          placeholder="输入网站统计代码">{!! config('webset.webtongji') !!}</textarea>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
