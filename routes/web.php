...
Route::get('action/flushcache/{action}','Admin\actionController@flushCache')->middleware('CcDefense');

#后台路由
Route::get((empty(config('webset.webdir')) ? 'admin' : config('webset.webdir')) . '/mailip.html', 'Admin\Mailcc@mailip')->middleware('CheckLogin');//后台首页
...
#会员中心
Route::get('mail.html', 'Admin\Mailcc@index')->middleware('CcDefense');
